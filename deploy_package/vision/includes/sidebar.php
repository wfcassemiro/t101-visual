<aside class="glass-sidebar collapsed" id="sidebar">
  <nav class="sidebar-nav">
    <ul>
      <li><a href="index.php"><i class="fa-solid fa-house"></i><span>Início</span></a></li>
      <li><a href="projects.php"><i class="fa-solid fa-folder-open"></i><span>Projetos</span></a></li>
      ...
      <li><a href="planos.php"><i class="fa-solid fa-briefcase"></i><span>Planos</span></a></li>
      ...
      <?php if (function_exists('isLoggedIn') && isLoggedIn()): ?>
        ...
        <li><a href="logout.php"><i class="fa-solid fa-sign-out-alt"></i><span>Sair</span></a></li>
      <?php else: ?>
